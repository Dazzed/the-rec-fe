  ...
  return (
    <>
      ...
      <p>
        ...
        <a href="http://www.get-tag.com">http://www.get-tag.com</a>, you are
      ...
      <ol type="a">
        <li>
          ...
          materials (information or software) on a's website for personal,
        ...
        <li>
          ...
          restrictions and may be terminated by a at any time. Upon terminating
      ...
      <ol type="a">
        <li>
          The materials on a's website are provided on an 'as is' basis. a makes
        ...
        <li>
          Further, a does not warrant or make any representations concerning the
      ...
      <h3>4. Limitations</h3>
      <p>
        In no event shall a or its suppliers be liable for any damages
        (including, without limitation, damages for loss of data or profit, or
        due to business interruption) arising out of the use or inability to use
        the materials on a's website, even if a or a a authorized representative
      ...
      <p>
        The materials appearing on a's website could include technical,
        typographical, or photographic errors. a does not warrant that any of
        the materials on its website are accurate, complete or current. a may
        make changes to the materials contained on its website at any time
        without notice. However a does not make any commitment to update the
        materials.
      </p>
      <h3>6. Links</h3>
      <p>
        a has not reviewed all of the sites linked to its website and is not
        responsible for the contents of any such linked site. The inclusion of
        any link does not imply endorsement by a of the site. Use of any such
        linked website is at the user's own risk.
      </p>
      <h3>7. Modifications</h3>
      <p>
        a may revise these terms of service for its website at any time without
      ...
      <p>
        ...
        with the laws of a and you irrevocably submit to the exclusive
