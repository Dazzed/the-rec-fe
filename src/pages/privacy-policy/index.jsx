function PrivacyPolicy() {
  return (
    <>
      ...
      <p>
        Your privacy is important to us. It is a's policy to respect your
        privacy regarding any information we may collect from you across our
        website, <a href="http://www.get-tag.com">http://www.get-tag.com</a>,
      ...
      <p>This policy is effective as of 22 December 2020.</p>
    </>
  );
}
